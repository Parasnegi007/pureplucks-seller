...
async function sendSellerOTP() {
  ...
  try {
    const res = await fetch("https://pureplucks.com/api/sellers/send-otp-email", {
      method: "POST",
...
async function verifySellerOTP() {
  ...
  try {
    const res = await fetch("https://pureplucks.com/api/sellers/verify-otp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function submitSellerSignup() {
  ...
  try {
    const res = await fetch("https://pureplucks.com/api/sellers/signup", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function handleSellerLogin() {
  ...
  try {
    const res = await fetch("https://pureplucks.com/api/sellers/login", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function sendForgotOtp() {
  ...
  try {
    const res = await fetch("https://pureplucks.com/api/sellers/forgot-password", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ email })
    });
...
async function resetForgotPassword() {
  ...
  try {
    const res = await fetch("https://pureplucks.com/api/sellers/forgot-password/reset", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
